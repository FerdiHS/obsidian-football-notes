...
`version:check` compares the recorded `minAppVersion` against `manifest.json` in Release Please branches, main-branch builds, and release-tag builds so shipped metadata stays honest.
