...
const playerModalConfig: NamedNoteModalConfig = {
...
void test('registerCreatePlayerNoteCommand wires the player command configuration', async () => {
	...
	assert.deepEqual(receivedConfig, playerModalConfig);
});
